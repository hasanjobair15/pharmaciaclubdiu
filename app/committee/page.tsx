    ...
    <main className="min-h-screen bg-[#f7faff] text-[#0b1736]">
      ...
      {facultyMembers.length > 0 && (
        <section className="mx-auto max-w-7xl px-6 py-20 lg:px-8">
          <div className="mb-10">
            ...
            <h2 className="mt-3 text-3xl font-black">Advisors</h2>
          </div>
      ...
      {members.length === 0 && (
        <section className="px-6 py-24 text-center">
          <h2 className="text-2xl font-black">Committee information coming soon</h2>
    ...
    <article className="group overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-sm transition duration-300 hover:-translate-y-1 hover:shadow-xl">
      ...
      <div className="p-6">
        ...
        <div className="mt-5 flex gap-2">
          <button className="rounded-full border border-slate-200 px-4 py-2 text-xs font-semibold transition hover:border-[#087f8c] hover:text-[#087f8c]">
            Profile
          </button>
